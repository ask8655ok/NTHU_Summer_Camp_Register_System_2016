class PrivateDataController < ApplicationController
  ...
  private
    ...
    def private_datum_params
      params.require(:private_datum).permit(:name, :nickname, :gender_id, :birthy_id, :birthm_id, :birthd_id, :personcard, :blood_id, :school, :schoolg_id, :schoolc, :schoolt_id, :address, :email, :fb, :cellphone, :urgentn, :urgentr, :urgentc, :specialeat, :specialsick, :vegetrian_id, :tshirtsize_id, :intro, :fpick, :spick, :tpick, :picture)
    end
end
